...
const Modal = (props) => {
  ...
  return ReactDom.createPortal(
    <div className='z-50 fixed inset-0 bg-white dark:bg-rose-500 text-black dark:text-black flex flex-col text-lg sm:text-xl'>
        ...
        <div className='p-4 flex flex-col gap-3'>
            {currentUser && <h2 onClick={() => {setOpenModal(false); router.push('/settings')}} className='select-none duration-300 hover:pl-2 cursor-pointer'><i className="mx-1 fa-solid fa-gear"></i>Settings</h2>}
